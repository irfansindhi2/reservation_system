...
<body id="home" data-spy="scroll" data-target=".navbar-collapse">
	...
	<div class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<a href="#home" class="navbar-brand smoothScroll"><strong>Take A Byte</strong></a>
			</div>
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="#home" class="smoothScroll">HOME</a></li>
					<li><a href="#about" class="smoothScroll">ABOUT</a></li>
					<li><a href="reserve.php" class="smoothScroll">RESERVE NOW</a></li>
		...
		<ul class="slides">
			<li>
				...
				<div class="flex-caption">
					<h2 class="slider-title">We make Pizza and have internet!</h2>
					<h3 class="slider-subtitle">Fresh, clean, and delicious.</h3>
					<p class="slider-description">Take A Byte is your one stop shop for your favorite pizza, beverages, and atmosphere. We have a large menu of food and drinks and have internet and video games for your entertainment needs!</p>
				</div>
			</li>
			<li>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<h1 class="text-uppercase">Welcome to Take A Byte!</h1>
				</div>
				<div class="col-md-6 col-sm-6">					
					<h3 class="text-uppercase padding-bottom-10">Your favorite pizza shop/internet cafe!</h3>
                    <p>Take A Byte is a brand new pizza place/internet cafe. We have tons of cool stuff here like pizza, internet, beer, video games, ice cream, and a great atmosphere.</p>
					<p>Take A Byte is not only the world's best new pizza shop/internet cafe, it's also the new home for your Fun Friday evenings with happy hour starting at 5 pm and video game tournmanets throughout the weekend.</p>
				...
				<div class="col-md-4 col-sm-4">
					<div class="gallery-wrapper">
						...
						<div class="gallery-des">
							<h3>Personal Pizzas </h3>
							<h5>Our Personal size pizzas are made to order and are never frozen or microwaved</h5>
						</div>
					</div>
				</div>	
				<div class="col-md-4 col-sm-4">
					<div class="gallery-wrapper">
						...
						<div class="gallery-des">
							...
							<h5>We offer both indoor and outdoor dining options</h5>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-4">
					<div class="gallery-wrapper">
						...
						<div class="gallery-des">
							<h3>Beverages</h3>
							<h5>To go along with our world class pizza we also offer a wide range of both alcoholic and non alcoholic drinks</h5>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-sm-6">
					<div class="gallery-wrapper">
						...
						<div class="gallery-des">
							...
							<h5>We have tons of different pizza toppings to add to your favorite slice of pizza</h5>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-sm-6">
					<div class="gallery-wrapper">
						...
						<div class="gallery-des">
							...
							<h5>With our online reservation system you can easily reserve a table instead of waiting on line</h5>
						</div>
					</div>
				</div>				
			</div>
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-4">
					...
					<p><i class="fa fa-envelope-o contact-fa"></i> 
                    	<a href="mailto:hello@company.com" class="contact-link">TakeAByte@byte.com</a></p>
				</div>
				<div class="col-md-4 col-sm-4">
	...
	<footer>
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<p>Copyright &copy; 2084 Take A Byte</p>
					<hr>
